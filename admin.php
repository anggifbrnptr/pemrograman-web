...
<head>
	<title>Toko Manis | <?php echo $websitetitle ?></title>
	<meta charset="utf-8">
...
<body>
				...
				<div class="stickythingy">
					<div style="padding: 40px;">
						<?php
									...
									?>
						<a target="_blank" href="<?php echo $baseurl ?>"><img src="<?php echo $currentlogo ?>"
								style="display: border-box; width: 100%;"></a>
					</div>
					<a href="<?php echo $baseurl ?>admin.php">
						<div class="adminleftbaritem"><i class="fa fa-home" style="width: 30px;"></i>
							<?php echo uilang("Home") ?></div>
					</a>
					<a href="<?php echo $baseurl ?>admin.php?newpost">
						<div class="adminleftbaritem"><i class="fa fa-plus" style="width: 30px;"></i>
							<?php echo uilang("Add Product") ?></div>
					</a>
					<a href="<?php echo $baseurl ?>admin.php?pictures">
						<div class="adminleftbaritem"><i class="fa fa-image" style="width: 30px;"></i>
							<?php echo uilang("Pictures") ?></div>
					</a>
					<a href="<?php echo $baseurl ?>admin.php?categories">
						<div class="adminleftbaritem"><i class="fa fa-tag" style="width: 30px;"></i>
							<?php echo uilang("Categories") ?></div>
					</a>
					<a href="<?php echo $baseurl ?>admin.php?orders">
						<div class="adminleftbaritem"><i class="fa fa-file-text" style="width: 30px;"></i>
							<?php echo uilang("Orders") ?></div>
					</a>
					<a href="<?php echo $baseurl ?>admin.php?settings">
						<div class="adminleftbaritem"><i class="fa fa-cogs" style="width: 30px;"></i>
							<?php echo uilang("Settings") ?></div>
					</a>
					<a href="<?php echo $baseurl ?>admin.php?logout">
						<div class="adminleftbaritem"><i class="fa fa-sign-out" style="width: 30px;"></i>
							<?php echo uilang("Logout") ?></div>
					</a>

					<div style="text-align: center; padding: 30px; font-size: 10px;">
						<?php echo uilang("Developed by") ?><br><a target="_blank" class="textlink" style="color: lime;"
							href="https://www.youtube.com/channel/UCKuD4mVSkV0cnvWFrjU3hHA">Youtube Anggi</a><br><br>Donate to the
						author:<br><a href="https://web.whatsapp.com/" class="textlink"
							style="color: lime;">WA Anda</a></div>
				</div>
			</div>
			<div
				style="display: table-cell; padding: 25px; vertical-align: top; border-left: 1px solid <?php echo $maincolor ?>; ">
				<?php
							//newpost
				...
				<div class="postform">
					...
					<form action="postupload.php" method="post" enctype="multipart/form-data">
						...
						<input type="number" step="0.01" name="newpostnormalprice"
							placeholder="<?php echo uilang("Price") ?>">
						<label><i class="fa fa-money"></i> <?php echo uilang("Discount Price") ?></label>
						<input type="number" step="0.01" name="newpostdiscountprice"
							placeholder="<?php echo uilang("Discount Price") ?>">
						...
						<div class="buybutton" onclick="showimagepicker()"><i class="fa fa-plus"></i>
							<?php echo uilang("Add") ?></div>
						<br><br>
						...
						<div id="moformbutton" class="buybutton" onclick="showmoform()"><i class="fa fa-plus"></i>
							<?php echo uilang("Add") ?></div>
						<div id="moform"
							style="border: 1px solid black; border-radius: 6px; padding: 20px; display: none;">
							...
							<div class="buybutton" onclick="addnewoptiontitle()"><i class="fa fa-plus"></i>
								<?php echo uilang("Add") ?></div>
							<div class="buybutton" onclick="closemoform()"><i class="fa fa-times"></i>
								<?php echo uilang("Close") ?></div>
						</div>
						<div id="moformedit"
							style="border: 1px solid black; border-radius: 6px; padding: 20px; display: none;">
							<h2><i class="fa fa-check-square-o"></i> <?php echo uilang("Edit") ?> <span
									id="motitletoedit"></span></h2>
							...
							<div class="buybutton" onclick="addcurrentmoitem()"><i class="fa fa-plus"></i>
								<?php echo uilang("Add") ?></div>
							<div class="buybutton" onclick="closemoeditform()"><i class="fa fa-times"></i>
								<?php echo uilang("Close") ?></div>
						</div>
				...
				<div style="margin-top: 50px">
					<form method="post" enctype="multipart/form-data">
						...
						<input class="fileinput" name="newmorepicture[]" type="file" accept="image/jpeg, image/png"
							multiple="multiple">
						<input name="submitmorepictures" type="submit" value="<?php echo uilang("Submit") ?>"
							class="submitbutton">
					</form>
				</div>
				<?php
				...
				<?php
								...
								if(isset($_GET["updatecategory"])){
									?>
				<h3><a href="<?php echo $baseurl ?>admin.php?categories"><i class="fa fa-arrow-left"></i>
						<?php echo uilang("Back") ?></a></h3>
				<?php
				...
				<form method="post">
					...
					<input type="text" placeholder="<?php echo uilang("Category") ?>" name="newcategoryupdate"
				...
				<?php
									...
									if(mysqli_num_rows($result) > 0){
										while($row = mysqli_fetch_assoc($result)){
											?>
				<div class="categoryblock"><i class="fa fa-tag"></i> <?php echo $row["category"] ?> <span
						style="margin-left: 20px; font-size: 12px; color: black;"><a
							href="<?php echo $baseurl ?>admin.php?categories&updatecategory=<?php echo $row["id"] ?>"><i
								class="fa fa-edit"></i> <?php echo uilang("Edit") ?></a> | <a
							href="<?php echo $baseurl ?>admin.php?categories&deletecategory=<?php echo $row["id"] ?>"><i
								class="fa fa-trash"></i> <?php echo uilang("Delete") ?></a></span></div>
				<?php
										}
									}else{
				...
				<form method="post" enctype="multipart/form-data">
					...
					<input placeholder="<?php echo uilang("Website Title") ?>" name="websitetitle"
						value="<?php echo stripslashes($cfg->websitetitle) ?>">

					<label><i class="fa fa-paint-brush"></i> <?php echo uilang("Main Color") ?></label>
					<input placeholder="<?php echo uilang("Main Color") ?>" name="maincolor"
						value="<?php echo $cfg->maincolor ?>" data-jscolor="">

					<label><i class="fa fa-paint-brush"></i> <?php echo uilang("Secondary Color") ?></label>
					<input placeholder="<?php echo uilang("Secondary Color") ?>" name="secondcolor"
						value="<?php echo $cfg->secondcolor ?>" data-jscolor="">

					<label><i class="fa fa-money"></i> <?php echo uilang("Currency Symbol") ?></label>
					<input placeholder="<?php echo uilang("Currency Symbol") ?>" name="currencysymbol"
					...
					<select name="disabledecimals">
						<option value=0 <?php if($cfg->disabledecimals == "0"){ echo "selected"; } ?>>
							<?php echo uilang("No") ?></option>
						<option value=1 <?php if($cfg->disabledecimals == "1"){ echo "selected"; } ?>>
							<?php echo uilang("Yes") ?></option>
					</select>
					<br>

					<label><i class="fa fa-whatsapp"></i> <?php echo uilang("Admin WhatsApp Phone Number") ?></label>
					<input placeholder="<?php echo uilang("Admin WhatsApp Phone Number") ?>" name="adminwhatsapp"
						value="<?php echo $cfg->adminwhatsapp ?>">

					<label><i class="fa fa-info"></i> <?php echo uilang("About") ?></label>
					<textarea placeholder="<?php echo uilang("About") ?>"
						name="about"><?php echo stripslashes($cfg->about) ?></textarea>
					<br>

					<label><i class="fa fa-language"></i> <?php echo uilang("Home Thumbnail Mode") ?></label>
					<select name="thumbnailmode">
						<option value=0 <?php if($cfg->thumbnailmode == "0"){ echo "selected"; } ?>>
							<?php echo uilang("Center Filled") ?></option>
						<option value=1 <?php if($cfg->thumbnailmode == "1"){ echo "selected"; } ?>>
					...
					<div style="display: inline-block; text-align: center; vertical-align: middle;">
						...
						<a href="<?php echo $baseurl ?>admin.php?settings&removelogo" class="textlink"><i
								class="fa fa-trash"></i> Remove</a>
					</div>
					<?php
									}
									?>
					<input name="newpicture" type="file" name="logo"
					...
					<input type="checkbox" name="sharebuttonsoption[]" value="Facebook"
						<?php if(IsChecked($sharebuttonsoption, "Facebook")){ echo "checked"; } ?>><label for="sbo1"
						style="display: inline-block;">Facebook</label>
					<input type="checkbox" name="sharebuttonsoption[]" value="Twitter"
						<?php if(IsChecked($sharebuttonsoption, "Twitter")){ echo "checked"; } ?>><label for="sbo2"
						style="display: inline-block;">Twitter</label>
					<input type="checkbox" name="sharebuttonsoption[]" value="Email"
						<?php if(IsChecked($sharebuttonsoption, "Email")){ echo "checked"; } ?>><label for="sbo3"
						style="display: inline-block;">Email</label>
					<input type="checkbox" name="sharebuttonsoption[]" value="Pinterest"
						<?php if(IsChecked($sharebuttonsoption, "Pinterest")){ echo "checked"; } ?>><label for="sbo4"
						style="display: inline-block;">Pinterest</label>
					<input type="checkbox" name="sharebuttonsoption[]" value="Linkedin"
						<?php if(IsChecked($sharebuttonsoption, "Linkedin")){ echo "checked"; } ?>><label for="sbo5"
						style="display: inline-block;">Linkedin</label>
					<input type="checkbox" name="sharebuttonsoption[]" value="WhatsApp"
						<?php if(IsChecked($sharebuttonsoption, "WhatsApp")){ echo "checked"; } ?>><label for="sbo6"
						style="display: inline-block;">WhatsApp</label>
					<input type="checkbox" name="sharebuttonsoption[]" value="Telegram"
						<?php if(IsChecked($sharebuttonsoption, "Telegram")){ echo "checked"; } ?>><label for="sbo7"
						style="display: inline-block;">Telegram</label>
					...
					<label><i class="fa fa-link"></i>
						<?php echo uilang("Base URL (make sure to include '/' symbol at the end)") ?></label>
					<input placeholder="<?php echo uilang("Base URL") ?>" name="baseurl"
						value="<?php echo $cfg->baseurl ?>">
				...
				<div class="postform">
					...
					<form action="postupdate.php" method="post" enctype="multipart/form-data">
						<label><i class="fa fa-edit"></i> <?php echo uilang("Title") ?></label>
						<input name="editposttitle" placeholder="<?php echo uilang("Title") ?>"
							value="<?php echo $row["title"] ?>">
						<label><i class="fa fa-money"></i> <?php echo uilang("Price") ?></label>
						<input type="number" step="0.01" name="editnormalprice"
							placeholder="<?php echo uilang("Price") ?>" value="<?php echo $row["normalprice"] ?>">
						<label><i class="fa fa-money"></i> <?php echo uilang("Discount Price") ?></label>
						<input type="number" step="0.01" name="editdiscountprice"
							placeholder="<?php echo uilang("Discount Price") ?>"
							value="<?php echo $row["discountprice"] ?>">
						<label><i class="fa fa-tag"></i> <?php echo uilang("Category") ?></label>
												...
												if(mysqli_num_rows($catresult) > 0){
													while($catrow = mysqli_fetch_assoc($catresult)){
														if($catrow["id"] == $row["catid"]){
															?>
							<option value="<?php echo $catrow["id"] ?>" selected="selected">
						...
						<label><i class="fa fa-check-square-o"></i> <?php echo uilang("Add more options") ?></label>
						<input id="moreoptions" name="moreoptions" value='<?php echo $row["options"] ?>'
							style="display: none;">
						<div id="moreoptionsvisual" style="margin-bottom: 10px;"></div>
						<div id="moformbutton" class="buybutton" onclick="showmoform()"><i class="fa fa-plus"></i>
							<?php echo uilang("Add") ?></div>
				...
				<table style="width: 100%">
					...
					<tr>
						<td><?php echo $postdate ?></td>
						<td><a target="_blank" href="<?php echo $baseurl . "?post=" . $row["postid"] ?>"><i
									class="fa fa-external-link"></i> <?php echo $row["title"] ?></a></td>
						<td><?php echo showCatName($row["catid"]) ?></td>
						<td><a href="<?php echo $baseurl ?>admin.php?editpost=<?php echo $row["id"] ?>"><i
									class="fa fa-edit"></i> <?php echo uilang("Edit") ?></a></td>
						<td><a
								href="<?php echo $baseurl ?>admin.php?deletepost=<?php echo $row["id"] ?>&title=<?php echo $row["title"] ?>"><i
									class="fa fa-trash"></i> <?php echo uilang("Delete") ?></a></td>
					</tr>
					<?php
											}
											?>
				...
				<?php
									...
									?>
				<script>
					alert("<?php echo uilang("
						WELCOME!\nClick OK to start.\nIf this message appears again,
						please check that you have correct database connection.
						") ?>")
					location.reload()
				</script>
				<?php
	...
	<script>
		function showimagepicker() {
			$("body").append(
				"<div id='imagepickerui'><h2 onclick='closeimagepicker()' style='cursor: pointer;'><i class='fa fa-arrow-left'></i> Back</h2><div id='imagepickercontent'>Please wait...</div>"
				)
		...
		function insertthis(img) {
			...
			$("#moreimagesvisual").append(
				"<div class='imgitem' style='display: inline-block; vertical-align: top;' onclick=removethis('" +
				randata + "')><div class='imgitemdatarand' style='display: none'>" + randata +
				"</div><div class='imgitemdata' style='display: none'>" + img + "</div><img src='" + img +
				"' style='height: 64px; margin: 10px; border-radius: 5px; cursor: not-allowed;'></div>")
			closeimagepicker()
			ipvisualtodata()
		}
		...
		function updatemovisual() {
			if (moptions.length == 1) {
				...
				for (var i = 0; i < moptions.length; i++) {
					mocontent += "<div class='categoryblock'><div><i class='fa fa-check-square-o'></i> " + moptions[i].title +
						"<span onclick='editmop(" + i +
						")'style='cursor: pointer; margin-left: 20px; font-size: 12px; color: black;'><i class='fa fa-edit'></i> <?php echo uilang("
					Edit ") ?></span></div>"
					if (moptions[i].options.length > 0) {
						for (var x = 0; x < moptions[i].options.length; x++) {
							mocontent += "<div style='font-size: 12px; padding: 10px;'><i class='fa fa-arrow-right'></i> " +
								moptions[i].options[x].title + " (" + tSep(moptions[i].options[x].price) + ")</div>"
						}
					}
					mocontent += "</div>"
				}
				...
				$("#moreoptionsvisual").html("<?php echo uilang("
					There is no option has been added.
					") ?>")
				$("#moformbutton").show()
			}
		}
